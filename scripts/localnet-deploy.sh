...
NO_DNA=1 solana program show DRtu8UJRPVQFyVboeX9uzx5qdgsGC9bVyViRCxHSgZwJ --url "${RPC_URL}"
...
NO_DNA=1 solana program show AQfDaprdLStvVNdsn9bNXUH5bwoaWXUbL54ZsJpNm5EV --url "${RPC_URL}"
...
NO_DNA=1 solana program show ENLdCrebMYYvRQFaMCNJAn3DCzEZSJ8JXpwVBFX9R7NH --url "${RPC_URL}"
NO_DNA=1 solana program show AeTFPGveiu5u9qaGpoCFLte95RBbaKYHcPA6VJHGzSJh --url "${RPC_URL}"
NO_DNA=1 solana program show AkakKkvTyQoT9jUeYze5KWG841RcpPfY8XV3Bzk5wn4Z --url "${RPC_URL}"
NO_DNA=1 solana program show HtQi1ESxw8jY5383gaTwtv8vwJbSKfZcFuRb3vPq86KU --url "${RPC_URL}"
NO_DNA=1 solana program show 6RLX336UuzR9yU4FCrLcTc1SE62YyPc57L8pqjk3xdwP --url "${RPC_URL}"
...
NO_DNA=1 solana program show 3UEFZZDhmaMh1mBZYvxZxk2PZ2Zb4niHg4wpg2iYiW8J --url "${RPC_URL}"
