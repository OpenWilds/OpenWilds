/**
 * Legacy MagicBlock implementation.
 *
 * This file preserves the previous monolithic runtime so behavior stays stable
 * while the new architecture is extracted around it. New code should not add
 * responsibilities here; move them into focused services such as
 * `read-service`, `write-service`, `session-service`, or
